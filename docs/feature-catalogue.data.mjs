  ...
  // ---------------------------------------------------------------------------
  {
    ...
    items: [
      ...
      },
      {
        id: "pex2-kpis",
        title: "Six KPI tiles",
        body: "**Net benefit** with the change against the prior period, **Gross benefit**, **Estate cost** (or the hub's cost, once a hub is selected), **ROI**, **vs annual target** (fiscal-year-to-date net against the estate's — or the selected hub's own — annual net benefit target, or a prompt when none is set), and **Projected FY-end** at the current run-rate.",
      },
      {
        id: "pex2-ops",
        title: "Operations this period",
        body: "A compact grid, for the estate or the selected hub: Completed cases (with a trend sparkline), Completion rate, Exception rate, Cost per completed case, FTE released and Colleague hours saved — each with its change against the prior period, and a target-met dot on the three metrics that carry a target. The card title names the hub and period, e.g. \"Operations this period — Risk — FY to date\".",
      },
      {
        id: "pex2-health",
        title: "Estate health",
        body: "Open breach and warning counts, active digital workers, average utilisation, spare capacity hours, and the three worst open alert headlines. Once a hub is selected this is scoped to that hub's own alerts, plus any estate-wide breach or warning — the same rule the Alerts page uses for a hub-scoped user.",
      },
      {
        id: "pex2-byhub",
        title: "By hub / By proposition table",
        body: "On the **Estate** view: one row per hub — net benefit, fiscal-year-to-date net, attainment against that hub's annual target, completed cases, exception rate, cost per completed case, and a trend arrow against the prior period. Once a **hub** is selected this table becomes **By proposition** instead: the same figures (minus the hub-level target column) broken down one row per proposition within that hub. A total row reconciles to the KPI tiles either way.",
      },
      {
        id: "pex2-movers",
        title: "Movers",
        body: "The top three processes by net benefit, and the bottom three running at a loss, each with the reason it was flagged (the same fixed rules as Value & Finance's review candidates) — drawn only from the estate, or only from the selected hub's own processes.",
      },
      {
        id: "pex2-briefing",
        title: "Briefing",
        body: "Three sentences generated from the live model, alerts and reference targets, scoped the same way as the rest of the page: a headline (fiscal-year-to-date net benefit and its target status), the highest-priority risk (the worst open breach, or the worst process exception rate above target when nothing has breached), and a recommended action (the top loss-making process and why).",
      },
      {
        id: "pex2-actions",
        title: "Print and Copy figures",
        body: "**Print** opens a print-friendly layout of the page. **Copy figures** copies every tile, table row and briefing sentence as tab-separated text to the clipboard, headed with the selected hub and period, for pasting into an email or a slide.",
      },
    ],
  },
