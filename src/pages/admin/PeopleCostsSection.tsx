...
const ownerLabel = (ownerId: string, reference: SectionProps["reference"]) =>
  ownerId === "HUB" ? "CoE" : reference.spokes.find((s) => String(s.spokeId) === ownerId)?.spokeName ?? `Owner ${ownerId}`;
